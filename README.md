...
To install first two of them on Mac OS X or Windows computers you just need to download a package from (http://nodejs.org/download/)[http://nodejs.org/download/]. For other platforms see the (readme)[https://npmjs.org/doc/README.html].
