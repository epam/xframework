            ...
            if (status !== 'success') {
                ...
                window.setTimeout(function () {
                    ...
                    var result = page.evaluate(function () {
                        $('body').append('<fieldset data-role="controlgroup" data-description="Test Fieldset"><legend>Legend</legend></fieldset>');
                        XF.trigger('ui:enhance', $('body'));

                        if ($('fieldset').length && $('fieldset').hasClass('xf-controlgroup')) {
                            return $('fieldset').attr('data-description');
                        }
                    }, 'result');
